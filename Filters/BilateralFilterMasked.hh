...
#ifndef FILTERS_BILATERALFILTERMASKED_H
#define FILTERS_BILATERALFILTERMASKED_H
...
namespace MDA {
  ...
  /** \class BilateralFilterMasked BilateralFilterMasked.hh
      Brute-force bilateral filtering, uses the last channel as a mask */
  template<class T>
  class BilateralFilterMasked: public Filter<T> {
  ...
  public:
    ...
    BilateralFilterMasked( double _sigma, double _edgeStopSigma= .1, int rad= -1 )
